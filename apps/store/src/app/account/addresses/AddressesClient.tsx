      ...
      <div className="flex items-center justify-between">
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogTrigger asChild>
            <button
              onClick={openNew}
              className="flex items-center gap-1.5 bg-(--tenant-primary) text-white text-sm font-semibold px-3.5 py-2 rounded-xl hover:bg-blue-800 transition-colors"
            >
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        formData.title === value
                          ? "border-(--tenant-primary) bg-blue-50 text-(--tenant-primary)"
              ...
              {mapCenter && (
                <div>
                  <p className="text-xs font-semibold text-gray-700 mb-1 flex items-center gap-1.5">
                    <MapPin className="w-3.5 h-3.5 text-(--tenant-primary)" />
              ...
              >
                ...
                <div className="flex items-center gap-1 border-t border-gray-50 pt-3">
                  <button
                    ...
                    className="flex items-center gap-1 text-xs text-gray-500 hover:text-(--tenant-primary) font-medium px-2 py-1 rounded-lg hover:bg-blue-50 transition-colors"
                  >
